...
export default function Header() {
  ...
  const { cartCount, wishlistCount, clearWishlist, clearCartState } =
        ...
        <div className="hidden md:flex items-center space-x-3">
          ...
          {!isLoggedIn ? (
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-lg">
