    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex flex-col items-center justify-center p-6">
      <div className="text-center max-w-md">
        <div className="mb-8 relative">
          ...
          <div className="absolute top-50 -right-2 w-12 h-12 bg-yellow-200 rounded-full animate-bounce opacity-40"></div>
          <div className="relative  top-55 -right-2 w-12 h-12 bg-yellow-200 rounded-full animate-bounce opacity-60"></div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
      ...
      <div className="bg-white/70 backdrop-blur-sm border-b border-purple-100 sticky top-0 z-10">
        ...
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/50">
            <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-gray-500 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            >
              ...
              <div className="p-6 sm:p-8">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg">
                        <span className="text-white font-bold text-lg">#{order.orderId.slice(-3)}</span>
                      </div>
                    </div>
                    <div>
                ...
                <div className="space-y-4">
                  {order.items.slice(0, expandedOrder === order.orderId ? order.items.length : 2).map((item) => (
                    <div key={item.id} className="flex items-center space-x-4 p-4 bg-gray-50/50 rounded-2xl hover:bg-gray-50 transition-colors">
                      <div className="flex-shrink-0">
                        <img
                          src={item.image}
                          alt={item.name}
